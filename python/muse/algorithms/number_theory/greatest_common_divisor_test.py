...
def test_greatest_common_divisor() -> bool:
    ...
    for i, _ in enumerate(sample):
        if (
            greatest_common_divisor.iterative_binary_gcd(sample[i][0], sample[i][1])
            != sample[i][2]
        ):
            return False
    ...
    for i, _ in enumerate(sample):
        if (
            greatest_common_divisor.recursive_binary_gcd(sample[i][0], sample[i][1])
            != sample[i][2]
        ):
            return False
    ...
    for i, _ in enumerate(sample):
        if (
            greatest_common_divisor.iterative_euclidean(sample[i][0], sample[i][1])
            != sample[i][2]
        ):
            return False
    ...
    for i, _ in enumerate(sample):
        if (
            greatest_common_divisor.recursive_euclidean(sample[i][0], sample[i][1])
            != sample[i][2]
        ):
            return False
