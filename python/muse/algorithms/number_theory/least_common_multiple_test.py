...
from muse.algorithms.number_theory import least_common_multiple
...
def test_least_common_multiple() -> bool:
    return (
        derive(least_common_multiple.reduce_to_binary_gcd)()
        and derive(least_common_multiple.reduce_to_euclidean)()
    )


def main() -> None:
    test_runner.pick(test_least_common_multiple)
