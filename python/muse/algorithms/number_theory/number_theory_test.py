...
def test_is_coprime() -> bool:
    ...
    for i, _ in enumerate(sample):
        if sample[i][2] == 0:
            if number_theory.is_coprime(sample[i][0], sample[i][1]):
                return False
        else:
            if not number_theory.is_coprime(sample[i][0], sample[i][1]):
                return False
...
def test_factorial() -> bool:
    ...
    for i, _ in enumerate(sample):
        if number_theory.fact(sample[i][0]) != sample[i][1]:
            return False
...
def test_fibonacci() -> bool:
    ...
    for i, _ in enumerate(sample):
        if number_theory.fibonacci(sample[i][0]) != sample[i][1]:
            return False
...
def test_gcd() -> bool:
    ...
    for i, _ in enumerate(sample):
        if number_theory.gcd(sample[i][0], sample[i][1]) != sample[i][2]:
            return False
...
def test_lcm() -> bool:
    ...
    for i, _ in enumerate(sample):
        if number_theory.lcm(sample[i][0], sample[i][1]) != sample[i][2]:
            return False
...
def test_is_even() -> bool:
    ...
    for i, _ in enumerate(sample):
        if sample[i][1] == 0:
            if not number_theory.is_even(sample[i][0]):
                return False
        else:
            if number_theory.is_even(sample[i][0]):
                return False
...
def test_is_odd() -> bool:
    ...
    for i, _ in enumerate(sample):
        if sample[i][1] == 0:
            if number_theory.is_odd(sample[i][0]):
                return False
        else:
            if not number_theory.is_odd(sample[i][0]):
                return False
...
def test_is_prime() -> bool:
    ...
    for i, _ in enumerate(sample):
        if sample[i][1] == 1:
            if number_theory.is_prime(sample[i][0]):
                return False
        elif sample[i][1] == 2:
            if not number_theory.is_prime(sample[i][0]):
                return False
        else:
            if number_theory.is_prime(sample[i][0]):
                return False
...
def test_is_composite() -> bool:
    ...
    for i, _ in enumerate(sample):
        if sample[i][1] == 1:
            if primality.is_composite(sample[i][0]):
                return False
        elif sample[i][1] == 2:
            if primality.is_composite(sample[i][0]):
                return False
        else:
            if not primality.is_composite(sample[i][0]):
                return False
...
def test_sieve_of_primes() -> bool:
    ...
    for i, _ in enumerate(sample):
        arr = number_theory.sieve_of_primes(sample[i][0])

        if len(arr) != sample[i][1]:
            return False

        for v in arr:
            if not primality.is_prime(v):
                return False
