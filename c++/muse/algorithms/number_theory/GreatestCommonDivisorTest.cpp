...
bool testGreatestCommonDivisor() {
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor::iterativeBinaryGCD(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor::recursiveBinaryGCD(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor::iterativeEuclidean(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor::recursiveEuclidean(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
...
int main() { TestRunner::pick(&testGreatestCommonDivisor); }
