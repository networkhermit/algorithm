#ifndef MUSE_DATA_STRUCTURES_ARRAY_LIST_HPP
#define MUSE_DATA_STRUCTURES_ARRAY_LIST_HPP
...
public:
  std::size_t size() { return logicalSize; }
  ...
  E front() { return get(0); }

  E back() { return get(logicalSize - 1); }

  void prepend(E element) { insert(0, element); }

  void append(E element) { insert(logicalSize, element); }

  void poll() { remove(0); }

  void eject() { remove(logicalSize - 1); }

  std::size_t capacity() { return physicalSize; }
