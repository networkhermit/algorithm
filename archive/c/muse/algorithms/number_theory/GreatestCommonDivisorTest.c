...
bool testGreatestCommonDivisor(void) {
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor_iterativeBinaryGCD(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor_recursiveBinaryGCD(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor_iterativeEuclidean(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
  ...
  for (size_t i = 0, size = *(&sample + 1) - sample; i < size; i++) {
    if (GreatestCommonDivisor_recursiveEuclidean(sample[i][0], sample[i][1]) !=
        sample[i][2]) {
      return false;
    }
  }
...
int main(void) { TestRunner_pick(&testGreatestCommonDivisor); }
