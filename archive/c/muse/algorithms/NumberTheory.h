#ifndef MUSE_ALGORITHMS_NUMBER_THEORY_H
#define MUSE_ALGORITHMS_NUMBER_THEORY_H
...
long NumberTheory_factorial(long n) { return Factorial_iterativeProcedure(n); }
...
bool NumberTheory_isEven(long n) { return Parity_bitwiseIsEven(n); }

bool NumberTheory_isOdd(long n) { return Parity_bitwiseIsOdd(n); }

bool NumberTheory_isPrime(long n) { return Primality_isPrime(n); }

bool NumberTheory_isComposite(long n) { return Primality_isComposite(n); }
