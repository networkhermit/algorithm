#ifndef MUSE_ALGORITHMS_NUMBER_THEORY_PRIME_SIEVES_HPP
#define MUSE_ALGORITHMS_NUMBER_THEORY_PRIME_SIEVES_HPP
...
std::vector<std::size_t> sieveOfEratosthenes(std::size_t n) {
  ...
  for (std::size_t i = 3, bound = static_cast<std::size_t>(
