#ifndef MUSE_DATA_STRUCTURES_CIRCULARLY_LINKED_LIST_HPP
#define MUSE_DATA_STRUCTURES_CIRCULARLY_LINKED_LIST_HPP
...
public:
  ...
  E back() { return get(length - 1); }

  void prepend(E element) { insert(0, element); }

  void append(E element) { insert(length, element); }

  void poll() { remove(0); }

  void eject() { remove(length - 1); }
};
} // namespace CircularlyLinkedList
