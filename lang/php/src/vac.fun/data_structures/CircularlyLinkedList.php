<?php
    namespace vac\fun\data_structures\CircularlyLinkedList;

    require_once "vac.fun/data_structures/interfaces/IList.php";

    use vac\fun\data_structures\interfaces\IList;
