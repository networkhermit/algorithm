<?php
    namespace fun\vac\algorithms\meta\NumberTheory;

    require_once "fun/vac/algorithms/number_theory/Coprimality.php";
    require_once "fun/vac/algorithms/number_theory/Factorial.php";
    require_once "fun/vac/algorithms/number_theory/FibonacciNumber.php";
    require_once "fun/vac/algorithms/number_theory/GreatestCommonDivisor.php";
    require_once "fun/vac/algorithms/number_theory/LeastCommonMultiple.php";
    require_once "fun/vac/algorithms/number_theory/Parity.php";
    require_once "fun/vac/algorithms/number_theory/Primality.php";
    require_once "fun/vac/algorithms/number_theory/PrimeSieves.php";
