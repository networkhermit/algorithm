#ifndef FUN_VAC_DATA_STRUCTURES_LINKED_LIST_H
#define FUN_VAC_DATA_STRUCTURES_LINKED_LIST_H 1
...
void LinkedList_insert(LinkedList *list, size_t index, linked_list_type element) {
    if (index < 0 || index > list->length) {
        fprintf(stderr, "[PANIC - IndexOutOfBounds]\n");
        exit(EXIT_FAILURE);
    }
...
void LinkedList_poll(LinkedList *list) {
