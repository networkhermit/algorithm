from fun.vac.algorithms.number_theory import Coprimality
from fun.vac.algorithms.number_theory import Factorial
from fun.vac.algorithms.number_theory import FibonacciNumber
...
from fun.vac.algorithms.number_theory import Parity
from fun.vac.algorithms.number_theory import Primality
from fun.vac.algorithms.number_theory import PrimeSieves
