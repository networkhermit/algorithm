require "vac.fun/algorithms/number_theory/Coprimality"
require "vac.fun/algorithms/number_theory/Factorial"
require "vac.fun/algorithms/number_theory/FibonacciNumber"
require "vac.fun/algorithms/number_theory/GreatestCommonDivisor"
require "vac.fun/algorithms/number_theory/LeastCommonMultiple"
require "vac.fun/algorithms/number_theory/Parity"
require "vac.fun/algorithms/number_theory/Primality"
require "vac.fun/algorithms/number_theory/PrimeSieves"
