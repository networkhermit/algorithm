...
func TestQuickSortThreeWayPartition(t *testing.T) {
	t.Parallel()
	t.Run("Decreasing", tests.DeriveDecreasing(SortThreeWayPartition, 100000))
	t.Run("Empty", tests.DeriveEmpty(SortThreeWayPartition))
	t.Run("Identical", tests.DeriveIdentical(SortThreeWayPartition, 100000))
	t.Run("Increasing", tests.DeriveIncreasing(SortThreeWayPartition, 100000))
...
func TestQuickSortInefficient(t *testing.T) {
	t.Parallel()
	t.Run("Decreasing", tests.DeriveDecreasing(SortInefficient, 100000))
	t.Run("Empty", tests.DeriveEmpty(SortInefficient))
	t.Run("Identical", tests.DeriveIdentical(SortInefficient, 100000))
	t.Run("Increasing", tests.DeriveIncreasing(SortInefficient, 100000))
